...
from systems.gcs.src.fleet_component.topics import FleetActions, SystemTopics
...
class FleetComponent(BaseSystem):
    ...
    def _register_handlers(self):
        self.register_handler(FleetActions.ALLOCATE, self._handle_allocate)
        self.register_handler(FleetActions.RELEASE, self._handle_release)
        self.register_handler(FleetActions.GET_STATUS, self._handle_get_status)
