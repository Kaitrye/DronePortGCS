...
from systems.gcs.src.robot_component.topics import (
    DronePortActions,
    DroneServiceActions,
    ExternalTopics,
    RobotActions,
...
class RobotComponent(BaseSystem):
    ...
    def _register_handlers(self):
        self.register_handler(RobotActions.EXECUTE_MISSION, self._handle_execute_mission)
        self.register_handler(RobotActions.ABORT_MISSION, self._handle_abort_mission)
