...
from systems.gcs.src.orchestrator_component.topics import OrchestratorActions, SystemTopics
...
class OrchestratorComponent(BaseSystem):
    ...
    def _register_handlers(self):
        self.register_handler(OrchestratorActions.PLAN, self._handle_plan)
        self.register_handler(OrchestratorActions.CANCEL, self._handle_cancel)
