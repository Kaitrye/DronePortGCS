...
from systems.gcs.src.mission_component.topics import MissionActions, SystemTopics
...
class MissionComponent(BaseSystem):
    ...
    def _register_handlers(self):
        self.register_handler(MissionActions.TASK_SUBMIT, self._handle_task_submit)
        self.register_handler(MissionActions.MISSION_CANCEL, self._handle_mission_cancel)
        self.register_handler(MissionActions.GET_MISSION, self._handle_get_mission)
