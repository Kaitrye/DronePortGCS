...
from systems.gcs.src.telemetry_component.topics import SystemTopics, TelemetryActions
...
class TelemetryComponent(BaseSystem):
    ...
    def _register_handlers(self):
        self.register_handler(TelemetryActions.TELEMETRY_UPDATE, self._handle_telemetry_update)
