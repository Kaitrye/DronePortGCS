...
from systems.gcs.src.redis_component.topics import RedisActions, SystemTopics
...
class RedisComponent(BaseSystem):
    ...
    def _register_handlers(self):
        self.register_handler(RedisActions.SAVE_MISSION, self._handle_save_mission)
        self.register_handler(RedisActions.GET_MISSION, self._handle_get_mission)
        self.register_handler(RedisActions.UPDATE_MISSION, self._handle_update_mission)
        self.register_handler(RedisActions.UPSERT_TELEMETRY, self._handle_upsert_telemetry)
        self.register_handler(RedisActions.ALLOCATE_DRONES, self._handle_allocate_drones)
        self.register_handler(RedisActions.RELEASE_DRONES, self._handle_release_drones)
        self.register_handler(RedisActions.GET_FLEET_STATUS, self._handle_get_fleet_status)
