...
from systems.gcs.src.gcs_comp_a.src.gcs_comp import DummyComponent
from systems.gcs.src.gcs_comp_a.topics import ComponentTopics


def main():
    component_id = os.environ.get("COMPONENT_ID", "gcs_comp_a")
