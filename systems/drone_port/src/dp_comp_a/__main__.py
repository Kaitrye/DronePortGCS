"""Точка входа для dp_comp_a в составе системы."""
import os
import sys
import signal
import time
...
from systems.drone_port.src.dp_comp_a.src.dp_comp import DummyComponent
from systems.drone_port.src.dp_comp_a.topics import ComponentTopics


def main():
    component_id = os.environ.get("COMPONENT_ID", "dp_comp_a")
