...
#     "lon": float,
#     "alt": float,
#     "param1": float, -- задержка в точке
#     "param2": float, -- радиус принятия точки
#     "param3": float, -- проходим сквозь точку или пролетаем мимо
#     "param4": float -- курс (куда смотрит "нос" дрона)
#     },
...
def expand_two_points_to_path(points, segments=DEFAULT_SEGMENTS):
    ...
    s_param1 = to_float(get_required(start, "param1", 0), "param1")
    s_param2 = to_float(get_required(start, "param2", 0), "param2")
    s_param3 = to_float(get_required(start, "param3", 0), "param3")
    ...
    e_param1 = to_float(get_required(end, "param1", 1), "param1")
    e_param2 = to_float(get_required(end, "param2", 1), "param2")
    e_param3 = to_float(get_required(end, "param3", 1), "param3")
...
def points_to_wpl(points, frame = DEFAULT_FRAME):
    ...
    for i, p in enumerate(points):
        ...
        param1 = to_float(p.get("param1",0.0), "param1")
        param2 = to_float(p.get("param2",0.0), "param2")
        param3 = to_float(p.get("param3",0.0), "param3")
        param4 = to_float(p.get("param4",0.0), "param4")
